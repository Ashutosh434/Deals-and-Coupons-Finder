...
!(function (a) {
  ...
  var b = function (b, c) {
    ...
    if (
      ((e.$element = a(b)),
      (e.options = a.extend({}, a.fn.typeahead.defaults, c)),
      (e.$menu = a(e.options.menu).insertAfter(e.$element)),
      (e.eventSupported = e.options.eventSupported || e.eventSupported),
      (e.grepper = e.options.grepper || e.grepper),
      (e.highlighter = e.options.highlighter || e.highlighter),
      (e.lookup = e.options.lookup || e.lookup),
      (e.matcher = e.options.matcher || e.matcher),
      (e.render = e.options.render || e.render),
      (e.onSelect = e.options.onSelect || null),
      (e.sorter = e.options.sorter || e.sorter),
      (e.source = e.options.source || e.source),
      (e.displayField = e.options.displayField || e.displayField),
      (e.valueField = e.options.valueField || e.valueField),
      (e.autoSelect = e.options.autoSelect || e.autoSelect),
      e.options.ajax)
    ) {
      var f = e.options.ajax;
      "string" == typeof f
        ? (e.ajax = a.extend({}, a.fn.typeahead.defaults.ajax, { url: f }))
        : ("string" == typeof f.displayField &&
            (e.displayField = e.options.displayField = f.displayField),
          "string" == typeof f.valueField &&
            (e.valueField = e.options.valueField = f.valueField),
          (e.ajax = a.extend({}, a.fn.typeahead.defaults.ajax, f))),
        e.ajax.url || (e.ajax = null),
        (e.query = "");
  ...
  (b.prototype = {
    ...
    select: function () {
      ...
      if (a.length) {
        ...
        this.options.onSelect && this.options.onSelect({ value: b, text: c }),
    ...
    ajaxLookup: function () {
      function c() {
        ...
        var c = this.ajax.preDispatch ? this.ajax.preDispatch(b) : { query: b };
      ...
      return b === this.query
        ...
        : ((this.query = b),
          this.ajax.timerId &&
            (clearTimeout(this.ajax.timerId), (this.ajax.timerId = null)),
          !b || b.length < this.ajax.triggerLength
            ? (this.ajax.xhr &&
                (this.ajax.xhr.abort(),
                (this.ajax.xhr = null),
                this.ajaxToggleLoadClass(!1)),
              this.shown ? this.hide() : this)
            : ((this.ajax.timerId = setTimeout(
                a.proxy(c, this),
                this.ajax.timeout
              )),
              this));
    ...
    ajaxSource: function (a) {
      ...
      if (b.ajax.xhr)
        return (
          b.ajax.preProcess && (a = b.ajax.preProcess(a)),
          (b.ajax.data = a),
          (c = b.grepper(b.ajax.data) || []),
          c.length
            ? ((b.ajax.xhr = null),
              b.render(c.slice(0, b.options.items)).show())
            : b.shown
            ? b.hide()
            : b
        );
    ...
    ajaxToggleLoadClass: function (a) {
      this.ajax.loadingClass &&
        this.$element.toggleClass(this.ajax.loadingClass, a);
    },
    lookup: function (a) {
      var c,
        b = this;
      return b.ajax
        ? void b.ajaxer()
        : ((b.query = b.$element.val()),
          b.query && (c = b.grepper(b.source))
            ? (0 == c.length && (c[0] = { id: -21, name: "Result not Found" }),
              b.render(c.slice(0, b.options.items)).show())
            : b.shown
            ? b.hide()
            : b);
      ...
      return (
        (b = a(b).map(function (b, f) {
          return (
            "object" == typeof f
              ? ((d = e
                  ? f[c.options.displayField]
                  : c.options.displayField(f)),
                (b = a(c.options.item).attr(
                  "data-value",
                  f[c.options.valueField]
                )))
              : ((d = f), (b = a(c.options.item).attr("data-value", f))),
            b.find("a").html(c.highlighter(d)),
            b[0]
          );
        })),
        c.autoSelect && b.first().addClass("active"),
        this.$menu.html(b),
        this
      );
    },
    grepper: function (b) {
      ...
      if (b[0].hasOwnProperty(c.options.displayField))
        d = a.grep(b, function (a) {
          return (
            (e = f ? a[c.options.displayField] : c.options.displayField(a)),
            c.matcher(e)
          );
        });
      else {
    ...
    next: function (b) {
      var c = this.$menu.find(".active").removeClass("active"),
        d = c.next();
      if (
        (d.length || (d = a(this.$menu.find("li")[0])), this.options.scrollBar)
      ) {
    ...
    prev: function (a) {
      var b = this.$menu.find(".active").removeClass("active"),
        c = b.prev();
      if (
        (c.length || (c = this.$menu.find("li").last()), this.options.scrollBar)
      ) {
    ...
    destroy: function () {
      this.$element
        .off("focus", a.proxy(this.focus, this))
        .off("blur", a.proxy(this.blur, this))
        .off("keypress", a.proxy(this.keypress, this))
        .off("keyup", a.proxy(this.keyup, this)),
        this.eventSupported("keydown") &&
          this.$element.off("keydown", a.proxy(this.keydown, this)),
        this.$menu
          .off("click", a.proxy(this.click, this))
          .off("mouseenter", "li", a.proxy(this.mouseenter, this))
          .off("mouseleave", "li", a.proxy(this.mouseleave, this)),
